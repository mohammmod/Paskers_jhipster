...
public class PaskersApp {

    private static final Logger log = LoggerFactory.getLogger(PaskersApp.class);

    private final Environment env;

    public PaskersApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(PaskersApp.class);
